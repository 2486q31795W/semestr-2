...
public class pr45 {
    public static void main(String arg []){
        System.out.println("Пожалуйста, введите число для конвертации в римские цифры: ");
        Scanner scan = new Scanner (System.in);
        int number = scan.nextInt();
        String romanDigit = "";
        if (number < 0 || number > 3999) {
            System.out.println( "Это число не конвертируется");
        }
        else
        {
            System.out.println("Введенное вами число, конвертируемое в римские цифры,равно: " + romanDigit);
